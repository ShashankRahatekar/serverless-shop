...
class PayButton extends Component {
  ...
  render() {
    ...
    return (
        ...
        <div>
          {alreadyOrdered ?
                <button className="btn btn-success btn-block paybutton-success-message" onClick={() => this.setState({alreadyOrdered: false})}>Thank You For Order!</button>
              :
              <div>
                {addedToBasket ? null : <button
                        ...
                        className="btn btn-primary btn-block paybutton-add-to-basket">Add To Basket</button>}
